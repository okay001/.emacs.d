...
(autoload (quote org-timer-pause-or-continue) "org-timer" "\
Pause or continue the relative timer.
With prefix arg STOP, stop it entirely.

\(fn &optional STOP)" t nil)

(autoload (quote org-timer-stop) "org-timer" "\
...
(autoload (quote org-update-all-dblocks) "org" "\
...
(autoload (quote org-forward-element) "org" "\
Move forward by one element.
Move to the next element at the same level, when possible.

\(fn)" t nil)

(autoload (quote org-backward-element) "org" "\
Move backward by one element.
Move to the previous element at the same level, when possible.

\(fn)" t nil)

(autoload (quote org-up-element) "org" "\
...
(autoload (quote org-drag-element-backward) "org" "\
Move backward element at point.

\(fn)" t nil)

(autoload (quote org-drag-element-forward) "org" "\
Move forward element at point.

\(fn)" t nil)

(autoload (quote org-mark-element) "org" "\
...
(autoload (quote org-narrow-to-element) "org" "\
Narrow buffer to current element.

\(fn)" t nil)

(autoload (quote org-transpose-element) "org" "\
Transpose current and previous elements, keeping blank lines between.
Point is moved after both elements.

\(fn)" t nil)

(autoload (quote org-unindent-buffer) "org" "\
